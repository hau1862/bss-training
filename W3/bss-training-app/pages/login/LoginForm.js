...
export default function LoginForm(props) {
  return <div className={`${formStyle.formContainer} ${props.classNameName}`}>
    <span className={formStyle.formHeading}>Soiot System</span>
    <form action="#" method="post" className={formStyle.form}>
